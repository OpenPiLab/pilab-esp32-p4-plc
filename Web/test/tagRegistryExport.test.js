...
test('applies editable tag metadata overrides without changing system I/O exclusions', () => {
  ...
  expect(start).toMatchObject({ value:true, units:'cmd', writable:false, retentive:true, hmi_visible:true, script_visible:true, description:'Edited start command metadata.' });
